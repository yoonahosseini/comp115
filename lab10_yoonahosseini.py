...
Your answer is: Nicely done, because the score is equal to the average but not lower but it's not bigger than 80.
...
Your answer is: Yes they have the same functionality, because it also returns the position of the target. 
...
functionality? Why? (5 marks)
Your answer is: Yes and no. They both search for the target but practice_for_index_3(nums, target) keeps searching for the target and practice_for_index_2(nums, target) stops after the target was found.
