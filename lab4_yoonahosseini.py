...
print(convert_american_dollars(1))
print(convert_american_dollars(100))
print(convert_american_dollars(100.05))
...
def calulate_alarm_time(current_time_string, waiting_time_string):
...
print(calulate_alarm_time(current_time_string,waiting_time_string))
...
result = sum_of_squares([2, 3, 4]) == 29
...
print(squares([1, 2, 3, 4])) # returns [1,4,9,16]
print(squares([2, 4, 6, 7, 8])) # returns [4,16,36,49,64]
