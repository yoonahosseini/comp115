...
while x < 10:
    x = x + 2
    print(x)
#My guess is that this code will print 2,4,6,8,10. 
#Correct
#---------------------------------------------------------
...
my_instructor_name = "COMP115 class 😄" # Change to "Yoona 😄"
my_name = "Yoona" # Change to your name
my_github_account = "https://github.com/COMP115-Bravo" # Change to your GitHub account
my_hobby = "weightlifting" # Change to your hobby
hours_coding_per_week = "6" # How many hours per week would you like to devote to learn coding?
...
project_interested = project_types[1]
